...
ansible -i ../hosts k8s    -m shell   -a "sudo rm -rf /var/lib/etcd" || exit 1
...
#nfs手动umount
#/run/containerd
ansible -i ../hosts k8s    -m shell   -a "sudo rm -rf /var/lib/kubelet /run/containerd/io.containerd.runtime.v2.task" || exit 1
